...
N 1110 120 1160 120 {lab=vin}
N 1395 420 1410 420 {lab=#net5
spice_ignore=true}
N 1410 420 1410 455 {lab=#net5
spice_ignore=true}
N 1315 420 1315 435 {lab=GND
spice_ignore=true}
N 1315 420 1335 420 {lab=GND
spice_ignore=true}
N -230 200 -230 390 {lab=vin}
N 1255 565 1255 590 {lab=#net6
spice_ignore=true}
N 1255 565 1330 565 {lab=#net6
spice_ignore=true}
...
N 80 20 135 20 {lab=#net5}
N 135 20 135 40 {lab=#net5}
N 135 40 170 40 {lab=#net5}
N 70 210 130 210 {lab=#net6}
N 130 210 130 230 {lab=#net6}
N 130 230 170 230 {lab=#net6}
N 470 225 710 225 {lab=#net7}
N 470 35 505 35 {lab=#net7}
N 505 35 505 225 {lab=#net7}
N 710 100 710 225 {lab=#net7}
N 1630 510 1630 535 {lab=x
spice_ignore=true}
N 1110 120 1110 340 {lab=vin}
N -230 340 1110 340 {lab=vin}
...
C {/foss/designs/SNN_IPN/Neuron/ultralif_final/ul_tun_final.sym} 650 90 0 0 {name=x3 W_LEAK=1 CM=0.8p spiceprefix=X}
...
C {/foss/designs/SNN_IPN/sw.sym} 1480 535 0 0 {name=x8
spice_ignore=true}
C {lab_pin.sym} 1120 40 1 0 {name=p3 sig_type=std_logic lab=hx}
C {vdd.sym} 1480 455 0 0 {name=l17 lab=VDD
spice_ignore=true}
C {gnd.sym} 650 150 0 0 {name=l18 lab=GND}
C {gnd.sym} 1250 150 0 1 {name=l19 lab=GND}
C {gnd.sym} 1480 615 0 0 {name=l20 lab=GND
spice_ignore=true}
C {gnd.sym} 320 90 0 0 {name=l21 lab=GND}
C {devices/vsource.sym} 1365 420 1 1 {name=Vin1 value="PWL(0 0 14.9m 0 15m 1.8)"
spice_ignore=true}
C {devices/gnd.sym} 1315 435 0 0 {name=l23 lab=GND
spice_ignore=true}
C {devices/vsource.sym} 1255 620 0 1 {name=Vin9 value=0.75
spice_ignore=true}
C {devices/gnd.sym} 1255 650 0 0 {name=l24 lab=GND
spice_ignore=true}
C {vdd.sym} 1250 10 0 1 {name=l25 lab=VDD}
