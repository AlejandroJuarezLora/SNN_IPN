...
N -590 -400 -590 -210 {lab=x}
N -650 -310 -590 -310 {lab=x}
...
N 750 -290 800 -290 {lab=#net5}
N 515 -110 530 -110 {lab=#net6
}
N 530 -110 530 -75 {lab=#net6
}
N 435 -110 435 -95 {lab=GND
}
N 435 -110 455 -110 {lab=GND
}
N -590 -210 -590 -20 {lab=x}
N 375 35 375 60 {lab=#net7
}
N 375 35 450 35 {lab=#net7
}
...
N -590 -450 -590 -400 {lab=x}
N -590 -450 -500 -450 {lab=x}
N -590 -260 -490 -260 {lab=x}
N -280 -390 -225 -390 {lab=#net8}
N -225 -390 -225 -370 {lab=#net8}
N -225 -370 -190 -370 {lab=#net8}
N -290 -200 -230 -200 {lab=#net9}
N -230 -200 -230 -180 {lab=#net9}
N -230 -180 -190 -180 {lab=#net9}
N 110 -185 350 -185 {lab=#net10}
N 110 -375 145 -375 {lab=#net10}
N 145 -375 145 -185 {lab=#net10}
N 350 -310 350 -185 {lab=#net10}
N 750 -290 750 -20 {lab=#net5}
N 750 -20 750 5 {lab=#net5}
N -590 -25 450 -25 {lab=x}
...
C {/foss/designs/SNN_IPN/Neuron/ultralif_final/ul_tun_final.sym} 290 -320 0 0 {name=x3 W_LEAK=1 CM=1p spiceprefix=X}
...
C {lab_pin.sym} -590 -360 0 0 {name=p1 sig_type=std_logic lab=x}
C {/foss/designs/SNN_IPN/sw.sym} 600 5 0 0 {name=x8
}
C {lab_pin.sym} 760 -370 1 0 {name=p3 sig_type=std_logic lab=hx}
C {vdd.sym} 600 -75 0 0 {name=l17 lab=VDD
}
C {gnd.sym} 290 -260 0 0 {name=l18 lab=GND}
C {gnd.sym} 890 -260 0 0 {name=l19 lab=GND}
C {gnd.sym} 600 85 0 0 {name=l20 lab=GND
}
C {gnd.sym} -40 -320 0 0 {name=l21 lab=GND}
C {devices/vsource.sym} 485 -110 1 1 {name=Vin1 value="PWL(0 1.8 19.9m 1.8 20m 0)"
}
C {devices/gnd.sym} 435 -95 0 0 {name=l23 lab=GND
}
C {devices/vsource.sym} 375 90 0 1 {name=Vin9 value=0.75
}
C {devices/gnd.sym} 375 120 0 0 {name=l24 lab=GND
}
...
C {vccs.sym} -460 -430 0 0 {name=G1 value="value='max(0, 235.29e-9 * (V(vin) - 0.4))'"}
C {vccs.sym} -450 -240 0 0 {name=G2 value="value='max(0, 235.29e-9 * (1.25 - V(vin)))'"}
