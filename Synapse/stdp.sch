...
C {devices/iopin.sym} 560 -450 2 1 {name=p3 lab=vout_post}
C {devices/iopin.sym} -40 -455 2 0 {name=p2 lab=vout_pre}
...
C {devices/lab_pin.sym} 320 -340 3 0 {name=p13 sig_type=std_logic lab=be}
C {devices/lab_pin.sym} 125 -340 3 0 {name=p14 sig_type=std_logic lab=te }
...
C {devices/lab_pin.sym} 400 -450 0 0 {name=p8 sig_type=std_logic lab=vss}
...
C {devices/lab_pin.sym} 115 -455 0 1 {name=p4 sig_type=std_logic lab=vss}
