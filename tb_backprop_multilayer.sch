...
N 1310 -165 1310 -90 {lab=x}
N 1310 -30 1310 -5 {lab=GND}
...
C {devices/code_shown.sym} -97.5 77.5 0 0 {name=MODELS2
only_toplevel=true
...
C {devices/code.sym} 642.5 312.5 0 0 {name=MODELS1
only_toplevel=true
format="tcleval( @value )"
value="
...
"
spice_ignore=false}
C {devices/code.sym} 650 120 0 0 {name=STIMULI3 
only_toplevel=true
place=end
value="
...
C {devices/gnd.sym} 1310 -5 0 1 {name=l2 lab=GND}
C {/foss/designs/SNN_IPN/layer/layer_output_rew.sym} 980 -150 0 0 {name=x2}
C {devices/vsource.sym} 1020 135 0 1 {name=Vin1 value=0.75
spice_ignore=true}
C {devices/vsource.sym} 1020 195 0 1 {name=Vin4 value="SINE(0 -0.44563 500 0 0)"
spice_ignore=true}
C {devices/vsource.sym} 1020 255 0 1 {name=Vin5 value="SINE(0 -0.1485 1500 0 0)"
spice_ignore=true}
C {devices/vsource.sym} 1020 315 0 1 {name=Vin6 value="SINE(0 -0.0891 2500 0 0)"
spice_ignore=true}
C {devices/vsource.sym} 1020 375 0 1 {name=Vin7 value="SINE(0 -0.0636 3500 0 0)"
spice_ignore=true}
C {devices/vsource.sym} 1020 435 0 1 {name=Vin8 value="SINE(0 -0.0495 4500 0 0)"
spice_ignore=true}
C {vsource_arith.sym} 1310 -60 0 0 {name=E1 VOL="'
0.800 +0.254648*sin(2*PI*1*time/0.005) -0.127324*sin(2*PI*2*time/0.005)
      +0.084882*sin(2*PI*3*time/0.005) -0.063662*sin(2*PI*4*time/0.005)
      +0.051000*sin(2*PI*5*time/0.005) -0.042441*sin(2*PI*6*time/0.005)
      +0.036378*sin(2*PI*7*time/0.005) -0.031831*sin(2*PI*8*time/0.005)
      +0.028294*sin(2*PI*9*time/0.005) -0.025465*sin(2*PI*10*time/0.005)'"}
