...
C {devices/vdd.sym} 430 80 1 0 {name=l2 lab=VDD}
...
C {devices/lab_pin.sym} 590 -10 0 1 {name=p1 sig_type=std_logic lab=vout}
C {devices/code_shown.sym} 620 -190 0 0 {name=s1 only_toplevel=false value="
.ac dec 10 1k 400k
.control
	run
	setplot ac1
...
C {devices/gnd.sym} 430 -100 2 0 {name=l6 lab=GND}
C {/home/alex/Desktop/EDA/SNN_IPN/OPAMP/opamp_mini.sym} 360 -90 2 1 {name=x1}
