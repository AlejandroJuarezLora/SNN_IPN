...
N 1310 -170 1310 20 {lab=x}
N 915 -10 915 85 {lab=#net13}
N 915 -10 1010 -10 {lab=#net13}
N 1215 -180 1215 -155 {lab=ctrl}
N 1085 -180 1215 -180 {lab=ctrl}
N 1090 -180 1090 -65 {lab=ctrl}
N 1090 -70 1090 -60 {lab=ctrl}
N 930 -420 1500 -420 {lab=Vr1}
N 1500 -420 1500 -390 {lab=Vr1}
...
C {devices/code_shown.sym} -37.5 107.5 0 0 {name=MODELS2
only_toplevel=true
...
C {devices/gnd.sym} 915 445 0 1 {name=l2 lab=GND}
C {devices/vsource.sym} 915 115 0 1 {name=Vin1 value=0.75
spice_ignore=false}
C {devices/vsource.sym} 915 175 0 1 {name=Vin4 value="SINE(0 -0.44563 500 0 0)"
spice_ignore=false}
C {devices/vsource.sym} 915 235 0 1 {name=Vin5 value="SINE(0 -0.1485 1500 0 0)"
spice_ignore=false}
C {devices/vsource.sym} 915 295 0 1 {name=Vin6 value="SINE(0 -0.0891 2500 0 0)"
spice_ignore=false}
C {devices/vsource.sym} 915 355 0 1 {name=Vin7 value="SINE(0 -0.0636 3500 0 0)"
spice_ignore=false}
C {devices/vsource.sym} 915 415 0 1 {name=Vin8 value="SINE(0 -0.0495 4500 0 0)"
spice_ignore=false}
C {sw.sym} 1160 20 0 0 {name=x7}
C {devices/gnd.sym} 1160 100 0 0 {name=l10 lab=GND}
C {devices/vdd.sym} 1160 -60 0 0 {name=l16 lab=VDD}
C {devices/vdd.sym} 1010 50 2 0 {name=l17 lab=VDD}
C {devices/vsource.sym} 1215 -125 0 1 {name=Vin3 value="PWL(0 1.8 19.9m 1.8 20m 0)"
spice_ignore=false}
C {devices/gnd.sym} 1215 -95 0 0 {name=l20 lab=GND}
C {devices/lab_pin.sym} 1145 -180 3 1 {name=p12 sig_type=std_logic lab=ctrl}
C {/foss/designs/SNN_IPN/Synapse/rstdp_array_8x4.sym} 540 -260 0 0 {name=x8}
C {/foss/designs/SNN_IPN/layer/layer_output_no_rew.sym} 980 -150 0 0 {name=x6}
