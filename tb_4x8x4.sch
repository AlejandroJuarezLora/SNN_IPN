...
spice_ignore=false}
C {devices/vsource.sym} 1390 65 0 1 {name=Vin3 value="PULSE(0.4 1.2 0 10u 10u 100u 200u)"
spice_ignore=true}
C {devices/lab_pin.sym} 160 -230 3 1 {name=p21 sig_type=std_logic lab=in
}
C {devices/gnd.sym} 1310 15 0 1 {name=l2 lab=GND}
C {/foss/designs/SNN_IPN/layer/layer_output_rew.sym} 980 -150 0 0 {name=x2}
C {devices/vsource.sym} 1310 -135 0 1 {name=Vin1 value="SINE(0.9 0.2 1000 0 0)"
spice_ignore=false}
C {devices/vsource.sym} 1310 -75 0 1 {name=Vin4 value="SINE(0 0.1 1500 0 30)"
spice_ignore=false}
C {devices/vsource.sym} 1310 -15 0 1 {name=Vin5 value="SINE(0 0.1 600 0 65)"
spice_ignore=false}
