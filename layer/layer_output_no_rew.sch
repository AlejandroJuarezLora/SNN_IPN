...
spice_ignore=true}
C {sky130_fd_pr/nfet_01v8.sym} 380 -1450 0 1 {name=M2
L=0.15
W=10
nf=1 
mult=1
...
C {devices/isource.sym} 360 -1540 0 0 {name=I1 value=100nA

spice_ignore=false}
C {devices/lab_pin.sym} 360 -1570 1 0 {name=p4 sig_type=std_logic lab=vdd}
C {devices/lab_pin.sym} 360 -1420 3 0 {name=p5 sig_type=std_logic lab=vss}
C {devices/lab_pin.sym} 450 -1450 1 0 {name=p6 sig_type=std_logic lab=vileak}
