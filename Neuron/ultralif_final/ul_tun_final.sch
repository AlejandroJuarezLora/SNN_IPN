...
N 140 -290 180 -290 {lab=#net3}
N 50 -390 60 -390 {lab=Iext}
N 130 -390 140 -390 {lab=#net3}
N 90 -460 90 -430 {lab=vout}
N 810 -130 850 -130 {lab=#net2}
N 810 -240 810 -130 {lab=#net2}
N 810 -240 850 -240 {lab=#net2}
N 890 -300 890 -270 {lab=vdd}
N 770 -170 810 -170 {lab=#net2}
...
N 1105 -300 1105 -270 {lab=vdd}
N 1105 -210 1105 -160 {lab=vout}
N 1105 -100 1105 -70 {lab=vss}
N 1105 -190 1235 -190 {lab=vout}
N 1235 -190 1245 -190 {lab=vout}
N 1105 -130 1165 -130 {lab=vss}
N 1165 -130 1165 -70 {lab=vss}
N 1105 -240 1185 -240 {lab=vdd}
N 1185 -285 1185 -240 {lab=vdd}
N 950 -70 1165 -70 {lab=vss}
N 890 -300 1105 -300 {lab=vdd}
N 970 -300 970 -285 {lab=vdd}
N 1105 -300 1185 -300 {lab=vdd}
N 1185 -300 1185 -285 {lab=vdd}
N 1000 -330 1000 -300 {lab=vdd}
N 1040 -240 1065 -240 {lab=vout_n}
N 1040 -240 1040 -130 {lab=vout_n}
N 1040 -130 1065 -130 {lab=vout_n}
N 1030 -190 1040 -190 {lab=vout_n}
...
C {devices/iopin.sym} 1245 -190 1 0 {name=p6 lab=vout}
C {devices/iopin.sym} 720 -30 0 0 {name=p2 lab=vss}
C {devices/iopin.sym} 320 -70 1 0 {name=p7 lab=Vleak }
C {devices/iopin.sym} 1000 -330 0 0 {name=p8 lab=vdd}
...
C {sky130_fd_pr/nfet_01v8.sym} 1085 -130 0 0 {name=M7
L=0.15
W=1
nf=1 
mult=1
...
C {sky130_fd_pr/pfet_01v8.sym} 1085 -240 0 0 {name=M8
L=0.15
W=2
nf=1
mult=1
...
C {devices/iopin.sym} 990 -190 1 0 {name=p14 lab=vout_n}
