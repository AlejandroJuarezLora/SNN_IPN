...
C {sky130_fd_pr/pfet_01v8.sym} 120 -310 3 1 {name=M9
L=0.15
W=4
nf=1
mult=1
...
.save i(vext) v(vout)
"}
C {devices/lab_pin.sym} 120 -200 3 0 {name=p1 sig_type=std_logic lab=vdd}
