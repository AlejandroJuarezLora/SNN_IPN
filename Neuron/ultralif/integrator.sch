...
C {sky130_fd_pr/cap_mim_m3_1.sym} 210 0 0 0 {name=Csyn model=cap_mim_m3_1 W=22.2 L=22.2 MF=1 spiceprefix=X }
...
C {devices/iopin.sym} 390 190 0 0 {name=p4 lab=Vout}
...
C {sky130_fd_pr/nfet_01v8.sym} 320 260 0 0 {name=M6
L=0.15
W=0.5
nf=1 
mult=1
