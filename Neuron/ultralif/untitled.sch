...
C {devices/vsource.sym} -590 130 0 0 {name=Vin1 value=1.8}
C {devices/gnd.sym} -590 180 0 0 {name=l8 lab=GND}
C {devices/isource.sym} 140 -180 0 0 {name=I0 value=1m}
C {devices/vdd.sym} 140 -210 0 0 {nname=l4 lab=VDD}
C {devices/isource.sym} 140 30 0 0 {name=I1 value=1m}
C {devices/vdd.sym} 140 0 0 0 {nname=l4 lab=VDD}
C {devices/isource.sym} 140 230 0 0 {name=I2 value=1m}
C {devices/vdd.sym} 140 200 0 0 {nname=l4 lab=VDD}
C {devices/isource.sym} 140 390 0 0 {name=I3 value=1m}
...
C {devices/isource.sym} 40 190 0 0 {name=I5 value=45n}
C {devices/gnd.sym} 40 230 0 0 {name=l10 lab=GND}
C {devices/isource.sym} 40 390 0 0 {name=I6 value=70n}
C {devices/gnd.sym} 40 430 0 0 {name=l11 lab=GND}
C {devices/isource.sym} 40 550 0 0 {name=I7 value=100n}
