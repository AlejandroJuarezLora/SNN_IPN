...
C {devices/vsource.sym} 290 10 0 0 {name=Vwl value="PWL(0 1.8)"
}
C {devices/vsource.sym} 230 -210 0 0 {name=Vbl value="PULSE(0 1.8 0 5n 5n 500n 1000n 10)"}
C {devices/gnd.sym} 420 40 0 0 {name=l1 lab=GND}
C {devices/launcher.sym} 840 20 0 0 {name=h5
descr="load waves" 
tclcommand="xschem raw_read $netlist_dir/tb_1v8.raw tran"
}
...
C {devices/vsource.sym} 540 -30 0 1 {name=Vsl value="PULSE(0 1.8 10u 5n 5n 500n 1000n 10)"}
